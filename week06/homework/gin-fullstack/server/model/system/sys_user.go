...
type SysUser struct {
	...
	LastLoginIP   string         `json:"lastLoginIp" gorm:"column:last_login_ip;size:64;comment:最后登录IP"`
	LastLoginAt   *time.Time     `json:"lastLoginAt" gorm:"column:last_login_at;comment:最后登录时间"`
